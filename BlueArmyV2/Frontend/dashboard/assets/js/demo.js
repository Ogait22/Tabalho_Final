...
window.onload = function(e) {
  ...
  .then(data => { 
    console.log(data);
    data.forEach(gear => {  
      var table = document.getElementById("tabelaGear");
      var row = table.insertRow(-1);
      var nameColuna = row.insertCell(0);
      var urlColuna = row.insertCell(1); 
      var setsColuna = row.insertCell(2);     
      nameColuna.innerHTML = gear.name;
      urlColuna.innerHTML = gear.url;
      setsColuna.innerHTML = gear.amount; 
    })
